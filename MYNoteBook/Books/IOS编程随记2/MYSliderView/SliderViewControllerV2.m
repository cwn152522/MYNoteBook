...
#import "SliderViewControllerV2.h"
#import "ViewController_SliderView.h"

@interface SliderViewControllerV2 ()<UITableViewDataSource>

@property (weak, nonatomic) IBOutlet UITableView *tableView;

@end

@implementation SliderViewControllerV2
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.textLabel setText:[NSString stringWithFormat:@"这是第二个视图控制器的第%ld个cell", indexPath.row + 1]];
    return cell;
}
