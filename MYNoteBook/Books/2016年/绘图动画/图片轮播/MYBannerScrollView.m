...
- (void)configUI{
    ...
    [_pageControl setLayoutCenterX:self];
    
    [self.scrollView addSubview:self.leftImageView];
    [self.scrollView addSubview:self.centerImageView];
    [self.scrollView addSubview:self.rightImageView];
    
    [_leftImageView setLayoutTopFromSuperViewWithConstant:0];
    [_leftImageView setLayoutLeftFromSuperViewWithConstant:0];
    ...
    [_leftImageView setLayoutRight:_centerImageView multiplier:1 constant:0];
    [_leftImageView setLayoutBottomFromSuperViewWithConstant:0];
   _imageWidth = [NSLayoutConstraint constraintWithItem:_leftImageView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1 constant:0] ;
    ...
    [_centerImageView setLayoutTopFromSuperViewWithConstant:0];
    [_centerImageView setLayoutHeight:_leftImageView multiplier:1 constant:0];
    [_centerImageView setLayoutRight:_rightImageView multiplier:1 constant:0];
    [_centerImageView setLayoutWidth:_leftImageView multiplier:1 constant:0];
    [_centerImageView setLayoutBottomFromSuperViewWithConstant:0];
    
    [_rightImageView setLayoutTopFromSuperViewWithConstant:0];
    [_rightImageView setLayoutHeight:_centerImageView multiplier:1 constant:0];
    [_rightImageView setLayoutRightFromSuperViewWithConstant:0];
    [_rightImageView setLayoutWidth:_centerImageView multiplier:1 constant:0];
