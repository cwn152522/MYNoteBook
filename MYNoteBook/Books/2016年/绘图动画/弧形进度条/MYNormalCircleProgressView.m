...
- (void)drawCircleProgressLayer{
    ...
    UIBezierPath *path = [UIBezierPath bezierPathWithArcCenter:CGPointMake(self.size.width/2, self.size.height/2) radius:self.size.width/2 - self.lineWidth startAngle:0.1 endAngle:M_PI_2  * 3.7 clockwise:YES];
