...
- (void)setStatus:(NSString *)string {
    ...
    if(string) {
        ...
        CGSize stringSize = [string boundingRectWithSize:CGSizeMake(200, 300) options:NSStringDrawingTruncatesLastVisibleLine attributes:@{NSFontAttributeName: self.stringLabel.font} context:nil].size;
