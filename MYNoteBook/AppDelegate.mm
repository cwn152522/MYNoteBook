...
//    [JPUSHService setTags:[NSSet setWithObject:@"abc"] aliasInbackground:@"def"];
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0f * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        [JPUSHService setTags:[NSSet setWithObject:@"abc"] alias:@"def" fetchCompletionHandle:^(int iResCode, NSSet *iTags, NSString *iAlias) {
